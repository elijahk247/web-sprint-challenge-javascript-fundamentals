...
console.log('Callback Step 3a: ', consume(2, 2, add)); // 4
console.log('Callback Step 3b: ', consume(10, 16, multiply)); // 160
console.log('Callback Step 3c: ', consume("Mary", "Poppins", greeting)); // Hello Mary Poppins, nice to meet you!
